...
public class PantallaCarga_ExpedirCodigo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_carga_expedir_codigo);

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                // Después del tiempo especificado, inicia la actividad principal
                Intent intent = new Intent(PantallaCarga_ExpedirCodigo.this, ExpedirCodigo.class);
