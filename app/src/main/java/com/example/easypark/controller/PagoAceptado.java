...
public class PagoAceptado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pago_aceptado);
        ...
        btnVolverHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intento = new Intent(PagoAceptado.this,HomeUsuario.class);
