...
public class PantallaCarga_RegistrarIncidencias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_carga_registrar_incidencias);

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                // Después del tiempo especificado, inicia la actividad principal
                Intent intent = new Intent(PantallaCarga_RegistrarIncidencias.this, RegistrarIncidencias.class);
