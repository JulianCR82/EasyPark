...
public class PantallaCarga_AjustarTarifas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_carga_ajustar_tarifas);

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                // Después del tiempo especificado, inicia la actividad principal
                Intent intent = new Intent(PantallaCarga_AjustarTarifas.this, AjustarTarifas.class);
